...
const RoleAccess = () => {
  ...
  const filteredRoleAccess = roleAccess.filter((entry) => {
    const verticalMatch = form.vertical_name
      ? entry.vertical_name === form.vertical_name
      : true;
    const positionMatch = form.position_name
      ? entry.position_name === form.position_name
      : true;
              ...
              <tbody>
                {filteredRoleAccess.length === 0 ? (
                  ...
                  filteredRoleAccess.map((entry) => (
                    <tr
                      key={entry.id}
                      className="hover:bg-[#ede7f6] transition"
                    >
