...
const ExamData = () => {
 ...
 const [examInfo, setExamInfo] = useState({
  ...
  exam_duration: '',
  number_of_questions: '',
  exam_file: '', // now a string, not null
  categories: ['']
});
  ...
  const handleFileChange = (e) => {
    setExamInfo({ ...examInfo, exam_file: e.target.files[0] });
  };
  ...
  // Add a new empty category input
  ...
  try {
    ...
    const payload = {
      ...
      exam_file: examInfo.exam_file, // Now a string
    ...
    setExamInfo({
      ...
      exam_duration: '',
      number_of_questions: '',
      exam_file: '', // Reset to empty string
      categories: ['']
    });
    await fetchExams();
  } catch (err) {
    ...
    <div className="w-full min-h-screen bg-white px-6 sm:px-10 ">
      ...
      <div className="max-w-4xl mx-auto bg-gray-50 rounded-xl shadow-sm p-6 mb-10 border border-gray-200">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          ...
          />
      <div>
  <label className="block text-sm mb-1">Exam File Name</label>
  <input
    type="text"
    name="exam_file"
        ...
        <div className="mt-4">
          ...
          <div className="flex flex-col gap-2">
            ...
            <button
              ...
              className="mt-2 px-3 py-1 bg-purple-100 hover:bg-purple-200 rounded text-sm text-[#4f378a] w-fit"
            >
              + Add Category
            </button>
          </div>
